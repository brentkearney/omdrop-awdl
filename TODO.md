...
- **The controlled 5 GHz receive test succeeded.** With `wld0` associated on 5 GHz channel 44, Hume on 6 GHz channel 69, and Hume's AWDL master on channel 6 with a 6/149 sequence, Hume discovered Omarchy and sent `chicken-game.jpg`. `/Discover`, `/Ask`, and `/Upload` all returned 200; the receiver stored the expected 61,812-byte file at 2026-09-18T01:55:20Z.
- That test separates the prior collision hypothesis: f0010's infrastructure channel 44 was not Hume's AWDL master or primary sequence channel. It also ran immediately after a module reload, so the fresh wiphy's world regulatory domain did not prevent 5 GHz association or AWDL receiving.
